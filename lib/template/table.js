...
exports.get = function (args, rows) {
    ...
    return {
        ...
        numcols: blank.length + 1,
        layoutTable: args.config.table.layout === 'table',
        allowInsert: args.config.editview.allowInsert,
        allowDelete: args.config.editview.allowDelete,
